...
public class BloomFilter<E> implements Serializable {
    ...
    public static void wordlistBenchmark() {
        try {
            ...
            BloomFilter bf = new BloomFilter<String>(0.01, 46000);
    ...
    public static void dictlistBenchmark() {
        try {
            ...
            BloomFilter bf = new BloomFilter<String>(0.01, 140000);
            while ((line = reader.readLine()) != null) {
                if (bf.contains(line)) {
    ...
    public static void numberBenchmark() {
        ...
        int count = i;
        int falseCount = 0;
        BloomFilter bf = new BloomFilter<String>(0.01, i);
        while (i-- > 0) {
            String x = i + "";
            if (bf.contains(x)) {
                falseCount++;
    ...
    public static void randomStringBenchmark() {
        ...
        int count = i;
        int falseCount = 0;
        BloomFilter bf = new BloomFilter(0.01, i);
        while (i-- > 0) {
